...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      localStorage.setItem('digifoliox_token', payload.access_token);
      localStorage.setItem('digifoliox_user_id', payload.user_id);
      localStorage.setItem('digifoliox_user_email', formData.email);
      navigate('/portfolios');
    } catch (error) {
          ...
          <div className="hidden lg:block">
            <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-2xl p-8 text-white">
              <div className="mb-8">
                ...
                <h2 className="text-3xl font-bold mb-4">Why Choose DigiFolioX?</h2>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg mb-1">4 Professional Templates</h3>
