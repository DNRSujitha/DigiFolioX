...
function Entry() {
    ...
    const fetchPortfolioData = async () => {
      try {
        ...
        if (localData) {
          ...
          setPortfolioData(enrichData(data));
          setError(null);
          setLoading(false);
          return;
        }
  ...
  // Helper function to enrich data with defaults
  const enrichData = (data) => {
    return {
      ...
      contactDetails: data.contactDetails || { email: '', mobile: '' },
      professionalLinks: data.professionalLinks || { github: '', linkedin: '', portfolio: '' },
      profession_metadata: data.profession_metadata || { label: 'Projects', description: 'Showcase your work and contributions' }
    };
  };
  ...
  return (
    <div className="old-aesthetic min-h-screen bg-cream">
      ...
      <div className="hidden">
        ...
        <meta name="description" content={portfolioData.about?.substring(0, 160) || 'Professional portfolio'} />
        <meta name="keywords" content={portfolioData.skills?.map(s => s.name).join(', ') || 'professional'} />
        ...
        <div className="bg-brown-dark/95 text-cream p-4 rounded-sm border border-gold/30 shadow-vintage-lg animate-fadeIn">
          <div className="flex items-center space-x-3">
            ...
            <div className="text-sm">
              ...
              <div className="text-cream/70 text-xs">Classic Portfolio • DigiFolioX</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="fixed bottom-20 right-6 z-50">
        <button
          ...
          className="bg-brown-dark text-cream p-3 rounded-sm border border-gold/30 shadow-vintage-lg hover:bg-brown-darker transition-colors"
          title="Go to Home"
        >
