...
function Footer({ data }) {
  ...
  const { name, contactDetails, skills = [], professionalLinks = {}, resumeUrl } = data || {};
    ...
    <footer className="bg-gradient-to-b from-gray-900 to-gray-800 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            ...
            <div className="md:col-span-2">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  <h2 className="text-2xl font-bold">{name || 'Portfolio'}</h2>
          ...
          {/* Social Media Links */}
          {(professionalLinks?.github || professionalLinks?.linkedin || professionalLinks?.portfolio || resumeUrl) && (
            <div className="mb-12 pb-8 border-b border-gray-800">
              <h3 className="text-lg font-semibold mb-6 text-center">Follow Me</h3>
              <div className="flex flex-wrap justify-center gap-4 items-center">
                ...
                {resumeUrl && (
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-3 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg hover:shadow-lg transition-all"
          ...
          {/* Skills Showcase - Fixed to show skill.name */}
          {skills.length > 0 && (
            <div className="mb-12">
          ...
          <div className="pt-8 border-t border-gray-800">
            <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
              <div className="flex items-center space-x-2 text-gray-400 text-sm">
                ...
                <span>{currentYear} {name || 'Portfolio'}. All rights reserved.</span>
              </div>
            ...
            <div className="mt-6 text-center text-gray-500 text-sm">
              <p>
                ...
                <span className="text-blue-400">DigiFolioX</span> • 
